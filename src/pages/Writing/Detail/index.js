...
import { Form, Input, Tabs, Button, Checkbox, Col, Row, Radio, message } from 'antd';
      ...
      <div className="writing-detail-container">
            <div className="writing-header">
                <div className="header-back">
                    <LeftCircleOutlined />
                    <div className="back-text" onClick={this.handleWritingSave.bind(this)}>保存并退出</div>
                </div>
            ...
            <div className="writing-detail">
                ...
                <div className="content-control">
                    <Button className="btn" type="primary" onClick={this.handleWritingSave.bind(this)}>提交</Button>
                </div>
            </div>
      </div>
    );
