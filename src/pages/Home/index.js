    ...
    return (
      <div className="main_container">
        ...
        <div className="mid-floor">
          ...
          <div className="icon-list">
            <div className="icon-email">
              <Popconfirm
                placement="top"
                title="koihyman@qingchengeng.com"
                icon={
                  <img
                    style={{
                      position: "absolute",
        ...
        <div className="icp-floor">
          ...
          <span className="icp-floor-copyright">
            Copyright © 2020 - 2021 奥尊科技 版权所有
          </span>
          <a
            target="_blank"
            href="http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=23010902000386"
            className="icp-floor-a"
          >
            <img src={police} />
            <span className="icp-floor-police">
              黑公网安备 23010902000386号
            </span>
          </a>
        </div>
        {mode === "login" ? (
            ...
            >
              ...
              <div className="form-area">
                ...
                <div className="btn-box">
                  ...
                  <div
                    className="login-box"
                    onClick={this.loginFinish.bind(this)}
                  >
                    登录
                  </div>
                </div>
